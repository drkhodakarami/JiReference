...
public class JiReference
 {
      ...
      */
     protected TagKey<net.minecraft.block.Block> createBlockTag(String name)
     {
      ...
      */
     protected TagKey<net.minecraft.item.Item> createItemTag(String name)
     {
      ...
      */
     protected TagKey<net.minecraft.item.Item> createItemCommonTag(String name)
     {
